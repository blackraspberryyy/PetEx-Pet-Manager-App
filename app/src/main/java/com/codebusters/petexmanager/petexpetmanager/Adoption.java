...
class Adoption {
    ...
    private int pet_id;
    private int user_id;
    private String adoption_proof_img;
    private Boolean adoption_isRead;
    private Boolean adoption_isMissing;
    private int adoption_adopted_at;
    ...
    public String getAdoption_proof_img() {
        return adoption_proof_img;
    }

    public void setAdoption_proof_img(String adoption_proof_img) {
        this.adoption_proof_img = adoption_proof_img;
    }

    public Boolean getAdoption_isRead() {
        return adoption_isRead;
    }

    public void setAdoption_isRead(Boolean adoption_isRead) {
        this.adoption_isRead = adoption_isRead;
    }

    public Boolean getAdoption_isMissing() {
        return adoption_isMissing;
    }

    public void setAdoption_isMissing(Boolean adoption_isMissing) {
        this.adoption_isMissing = adoption_isMissing;
    }

    public int getAdoption_adopted_at() {
        return adoption_adopted_at;
    }

    public void setAdoption_adopted_at(int adoption_adopted_at) {
        this.adoption_adopted_at = adoption_adopted_at;
    }
