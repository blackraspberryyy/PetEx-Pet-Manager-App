...
public final class SuperTask extends AsyncTask<Void, Void, String> {
    ...
    public static SuperTask execute(Context context, String id, String url) {
        SuperTask superTask = (SuperTask) new SuperTask(context, id, url).execute();
        return superTask;
    }
